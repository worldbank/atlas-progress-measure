## Calculate progress in the women political empowerment index
...
# Input data
indicator_wdi <- "WOMEN.INDEX"
load("input/gender.Rda")
data_wdi <- gender %>%
  select(year, code, gender)
...
writexl::write_xlsx(dashboard, "intermediate/dashboard_output_gender.xlsx")
